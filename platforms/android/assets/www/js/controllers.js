...
.controller('TabCtrl', function($ionicPlatform, $rootScope, $scope, $state, $stateParams, $ionicHistory, $translate) {
...
.controller('CardCtrl', function($ionicPlatform, $rootScope, $scope, $state, $stateParams, $ionicHistory, $ionicModal, $ionicPopup, $timeout, $translate, $http) {
  ...
  $scope.$on('$ionicView.enter', function() {
    ...
    $ionicPlatform.ready(function() {
      ...
      function(er) {
        // console.log('ERRRROR '+JSON.stringify(er))
      });
...
.controller('ElseCtrl', function($rootScope, $scope, $state, $stateParams, $ionicHistory, $ionicModal, $ionicPopup, $ionicActionSheet, $cordovaSQLite, $cordovaDevice, $timeout, $translate, $ionicLoading, $http, $cordovaNetwork, $cordovaCamera, $cordovaFile, $cordovaFileTransfer, $cordovaImagePicker, $cordovaBarcodeScanner, Inst, Cart, Bill, Profile, HtmlEnt, FAQ) {
  ...
  $scope.$on('$ionicView.enter', function(){
    ...
    $translate(['conn_err_tit', 'conn_err_tmp', 'conn_err_close', 'else_push_thank', 'else_push_thank_text', 'else_push_btn_close', 'review_ctrl_pop_thanks_tit', 'review_ctrl_pop_thanks_temp', 'review_ctrl_pop_thanks_btn1', 'else_review_choise', 'else_review_choose_pic', 'else_review_make_pic', 'else_review_take_pic', 'else_review_cancel', 'blocked_title', 'blocked_body', 'blocked_cancel', 'else_pop_phone_tit', 'else_pop_phone_tmp', 'else_pop_phone_btn1', 'else_pop_phone_btn2', 'promo_modal_pop_tit', 'promo_modal_pop_tmp', 'promo_modal_pop_btn', 'promo_modal_pop_succ_tit', 'promo_modal_pop_succ_tmp', 'promo_modal_pop_succ_btn', 'promo_modal_pop_wrong_tit', 'promo_modal_pop_wrong_tmp', 'promo_modal_pop_wrong_btn', 'discount_modal_pop_tit', 'discount_modal_pop_tmp', 'discount_modal_pop_btn1', 'discount_modal_pop_btn2', 'discount_modal_exists_pop_tit', 'discount_modal_exists_pop_tmp', 'discount_modal_exists_pop_btn', 'discount_modal_wrong_pop_tit', 'discount_modal_wrong_pop_tmp', 'discount_modal_wrong_pop_btn1', 'discount_modal_wrong_pop_btn2', 'discount_modal_err_pop_tit', 'discount_modal_err_pop_tmp', 'discount_modal_err_pop_btn', 'promo_modal_pop_notallowed_tit', 'promo_modal_pop_notallowed_tmp', 'promo_modal_pop_notallowed_btn']).then(function(res) {
      ...
      $scope.promo_modal_pop_notallowed_tit = res.promo_modal_pop_notallowed_tit;
      $scope.promo_modal_pop_notallowed_tmp = res.promo_modal_pop_notallowed_tmp;
      $scope.promo_modal_pop_notallowed_btn = res.promo_modal_pop_notallowed_btn;
    ...
    $http.post($rootScope.generalscript, promostr).then(function(e) {
        ...
        if(promocodeOK == 0) {
          ...
          var errPopup = $ionicPopup.alert({
            ...
            var errPopup = $ionicPopup.alert({
              title: '<i class="icon ion-alert redtxt alerts" />',
              template: '<h3 class="hh3"><strong>'+$scope.promo_modal_pop_notallowed_tit+'</strong></h3><h4 class="hh4">'+$scope.promo_modal_pop_notallowed_tmp+'</h4>',
              cssClass: 'gifterr',
              scope: $scope,
              buttons: [
                {
                  text: '<h3>'+$scope.promo_modal_pop_notallowed_btn+'</h3>',
                  type: 'button-full button-clear darkgreentxt',
                  onTap: function(e) {
                      errPopup.close();
                  }
