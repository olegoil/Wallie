...
var comment_payout_extension = new Serializer("comment_payout_extension", {
    payer: string,
    author: string,
    permlink: string,
    extension_time: optional(time_point_sec),
...
var asset_force_settle = new Serializer("asset_force_settle", {
    account: string,
    amount: asset,
...
var operation_wrapper = new Serializer("operation_wrapper", { op: operation });
...
var fill_call_order = new Serializer("fill_call_order", {
    order_id: uint32,
    owner: string,
    pays: asset,
    receives: asset,
...
var fill_settlement_order = new Serializer("fill_settlement_order", {
    order_id: uint32,
    owner: string,
    pays: asset,
    receives: asset,
...
// _16 for 0.16.4
var vote_16 = new Serializer("vote_16", {
    voter: string,
    author: string,
    permlink: string,
    weight: int16
...
var comment_16 = new Serializer("comment_16", {
    parent_author: string,
    parent_permlink: string,
    author: string,
    permlink: string,
...
var transfer_16 = new Serializer("transfer_16", {
    from: string,
    to: string,
    amount: asset_16,
    memo: string
...
var transfer_to_vesting_16 = new Serializer("transfer_to_vesting_16", {
    from: string,
    to: string,
    amount: asset_16
});

var withdraw_vesting_16 = new Serializer("withdraw_vesting_16", {
    account: string,
    vesting_shares: asset_16
});

var limit_order_create_16 = new Serializer("limit_order_create_16", {
    owner: string,
    order_id: uint32,
...
var limit_order_cancel_16 = new Serializer("limit_order_cancel_16", {
    owner: string,
    order_id: uint32
});

var price_16 = new Serializer("price_16", {
    base: asset_16,
    quote: asset_16
});

var feed_publish_16 = new Serializer("feed_publish_16", {
    publisher: string,
    exchange_rate: price_16
});

var convert_16 = new Serializer("convert_16", {
    owner: string,
    request_id: uint32,
    amount: asset_16
});

var account_create_16 = new Serializer("account_create_16", {
    fee: asset_16,
    creator: string,
    new_account_name: string,
    owner: authority,
...
var account_update_16 = new Serializer("account_update_16", {
    account: string,
    owner: optional(authority),
    active: optional(authority),
    posting: optional(authority),
...
var chain_properties_16 = new Serializer("chain_properties_16", {
    account_creation_fee: asset_16,
    maximum_block_size: uint32,
    sbd_interest_rate: uint16
});

var witness_update_16 = new Serializer("witness_update_16", {
    owner: string,
    url: string,
    block_signing_key: public_key,
...
var account_witness_vote_16 = new Serializer("account_witness_vote_16", {
    account: string,
    witness: string,
    approve: bool
});

var account_witness_proxy_16 = new Serializer("account_witness_proxy_16", {
    account: string,
    proxy: string
});

var pow_16 = new Serializer("pow_16", {
    worker_account: string,
    block_id: bytes(20),
    nonce: uint64,
    work: pow,
...
var report_over_production_16 = new Serializer("report_over_production_16", {
    reporter: string,
    first_block: signed_block_header,
    second_block: signed_block_header
});

var delete_comment_16 = new Serializer("delete_comment_16", {
    author: string,
    permlink: string
});

var comment_options_16 = new Serializer("comment_options_16", {
    author: string,
    permlink: string,
    max_accepted_payout: asset,
    percent_steem_dollars: uint16,
...
var set_withdraw_vesting_route_16 = new Serializer("set_withdraw_vesting_route_16", {
    from_account: string,
    to_account: string,
    percent: uint16,
    auto_vest: bool
...
var limit_order_create2_16 = new Serializer("limit_order_create2_16", {
    owner: string,
    order_id: uint32,
    amount_to_sell: asset_16,
    exchange_rate: price_16,
...
var challenge_authority_16 = new Serializer("challenge_authority_16", {
    challenger: string,
    challenged: string,
    require_owner: bool
});

var prove_authority_16 = new Serializer("prove_authority_16", {
    challenged: string,
    require_owner: bool
});

var request_account_recovery_16 = new Serializer("request_account_recovery_16", {
    recovery_account: string,
    account_to_recover: string,
    new_owner_authority: authority,
    extensions: set(future_extensions)
...
var recover_account_16 = new Serializer("recover_account_16", {
    account_to_recover: string,
    new_owner_authority: authority,
    recent_owner_authority: authority,
    extensions: set(future_extensions)
...
var change_recovery_account_16 = new Serializer("change_recovery_account_16", {
    account_to_recover: string,
    new_recovery_account: string,
    extensions: set(future_extensions)
});

var escrow_transfer_16 = new Serializer("escrow_transfer_16", {
    from: string,
    to: string,
    sbd_amount: asset_16,
...
var escrow_dispute_16 = new Serializer("escrow_dispute_16", {
    from: string,
    to: string,
    agent: string,
    who: string,
...
var escrow_release_16 = new Serializer("escrow_release_16", {
    from: string,
    to: string,
    agent: string,
    who: string,
...
var pow2_16 = new Serializer("pow2_16", {
    work: static_variant([pow2, equihash_pow]),
    new_owner_key: optional(public_key),
    props: chain_properties_16
});

var escrow_approve_16 = new Serializer("escrow_approve_16", {
    from: string,
    to: string,
    agent: string,
    who: string,
...
var transfer_to_savings_16 = new Serializer("transfer_to_savings_16", {
    from: string,
    to: string,
    amount: asset_16,
    memo: string
...
var transfer_from_savings_16 = new Serializer("transfer_from_savings_16", {
    from: string,
    request_id: uint32,
    to: string,
    amount: asset_16,
...
var cancel_transfer_from_savings_16 = new Serializer("cancel_transfer_from_savings_16", {
    from: string,
    request_id: uint32
});

var decline_voting_rights_16 = new Serializer("decline_voting_rights_16", {
    account: string,
    decline: bool
});

var reset_account_16 = new Serializer("reset_account_16", {
    reset_account: string,
    account_to_reset: string,
    new_owner_authority: authority
});

var set_reset_account_16 = new Serializer("set_reset_account_16", {
    account: string,
    current_reset_account: string,
    reset_account: string
});

var comment_benefactor_reward_16 = new Serializer("comment_benefactor_reward_16", {
    benefactor: string,
    author: string,
    permlink: string,
    reward: asset_16
...
var fill_convert_request_16 = new Serializer("fill_convert_request_16", {
    owner: string,
    requestid: uint32,
    amount_in: asset_16,
    amount_out: asset_16
...
var author_reward_16 = new Serializer("author_reward_16", {
    author: string,
    permlink: string,
    sbd_payout: asset_16,
...
var curation_reward_16 = new Serializer("curation_reward_16", {
    curator: string,
    reward: asset_16,
    comment_author: string,
    comment_permlink: string
...
var comment_reward_16 = new Serializer("comment_reward_16", {
    author: string,
    permlink: string,
    payout: asset_16
});

var liquidity_reward_16 = new Serializer("liquidity_reward_16", {
    owner: string,
    payout: asset_16
});

var interest_16 = new Serializer("interest_16", {
    owner: string,
    interest: asset_16
});

var fill_vesting_withdraw_16 = new Serializer("fill_vesting_withdraw_16", {
    from_account: string,
    to_account: string,
    withdrawn: asset_16,
    deposited: asset_16
...
var fill_order_16 = new Serializer("fill_order_16", {
    current_owner: string,
    current_order_id: uint32,
...
var shutdown_witness_16 = new Serializer("shutdown_witness_16", {
    owner: string
});

var fill_transfer_from_savings_16 = new Serializer("fill_transfer_from_savings_16", {
    from: string,
    amount: asset_16,
    request_id: uint32,
    to: string,
...
var hardfork_16 = new Serializer("hardfork_16", {
    hardfork_id: uint32
});

var comment_payout_update_16 = new Serializer("comment_payout_update_16", {
    author: string,
    permlink: string
});

operation.st_operations = [vote_16, comment_16, transfer_16, transfer_to_vesting_16, withdraw_vesting_16, limit_order_create_16, limit_order_cancel_16, feed_publish_16, convert_16, account_create_16, account_update_16, witness_update_16, account_witness_vote_16, account_witness_proxy_16, pow_16, custom, report_over_production_16, delete_comment_16, custom_json, comment_options_16, set_withdraw_vesting_route_16, limit_order_create2_16, challenge_authority_16, prove_authority_16, request_account_recovery_16, recover_account_16, change_recovery_account_16, escrow_transfer_16, escrow_dispute_16, escrow_release_16, pow2_16, escrow_approve_16, transfer_to_savings_16, transfer_from_savings_16, cancel_transfer_from_savings_16, custom_binary, decline_voting_rights_16, reset_account_16, set_reset_account_16, comment_benefactor_reward_16, vote, comment, transfer, transfer_to_vesting, withdraw_vesting, limit_order_create, limit_order_cancel, feed_publish, convert, account_create, account_update, witness_update, account_witness_vote, account_witness_proxy, pow, report_over_production, delete_comment, comment_options, set_withdraw_vesting_route, limit_order_create2, challenge_authority, prove_authority, request_account_recovery, recover_account, change_recovery_account, escrow_transfer, escrow_dispute, escrow_release, pow2, escrow_approve, transfer_to_savings, transfer_from_savings, cancel_transfer_from_savings, decline_voting_rights, reset_account, set_reset_account, comment_benefactor_reward, delegate_vesting_shares, account_create_with_delegation, comment_payout_extension, asset_create, asset_update, asset_update_bitasset, asset_update_feed_producers, asset_issue, asset_reserve, asset_fund_fee_pool, asset_settle, asset_force_settle, asset_global_settle, asset_publish_feed, asset_claim_fees, call_order_update, account_whitelist, override_transfer, proposal_create, proposal_update, proposal_delete, bid_collateral, fill_convert_request_16, author_reward_16, curation_reward_16, comment_reward_16, liquidity_reward_16, interest_16, fill_vesting_withdraw_16, fill_order_16, shutdown_witness_16, fill_transfer_from_savings_16, hardfork_16, comment_payout_update_16, fill_convert_request, author_reward, curation_reward, comment_reward, liquidity_reward, interest, fill_vesting_withdraw, fill_order, shutdown_witness, fill_transfer_from_savings, hardfork, comment_payout_update, return_vesting_delegation, asset_settle_cancel, fill_call_order, fill_settlement_order, execute_bid];
